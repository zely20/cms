...
<div class="container mt-3">
    ...
    <button type="button" class="btn btn-primary" onclick="hide()">Toggle</button>
    <div class="row">
        <h4>Тестовое CRM</h4>
    </div>
    <div class="row">
    ...
    <div class="row" id="unpublished" style="display:none;">
        ...
        <table class="table" >
            ...
            <tbody>
            <c:forEach items="${unpublishedPages}" var="page">
                <tr>
                    <td><c:out value="${page.title}"/></td>
                    <td><c:out value="${page.description}"/></td>
                    <td><a href="<c:url value='/content/${page.id}'/>">${page.menuLabel}</a></td>
